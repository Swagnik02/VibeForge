        ...
        children: [
          ...
          Row(
            children: [
              ...
              Icon(Icons.favorite_rounded, color: Colors.red, size: 50),
              // Text('for Anusha',
              //     style: TextStyle(fontFamily: Fonts.asul, fontSize: 18)),
            ],
          ),
...
class _CreatorsChoice extends StatelessWidget {
  const _CreatorsChoice({super.key, required this.songs});
...
class _Playlists extends StatelessWidget {
  const _Playlists({super.key, required this.playlists});
